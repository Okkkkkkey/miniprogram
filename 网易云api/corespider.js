var CryptoJS = CryptoJS || function (u, p) {
    var d = {}, l = d.lib = {}, s = function () {
        ...
        reset: function () {
            ...
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k) this.tC4G(e, q);
                q = e.splice(0, a);
                c.sigBytes -= j
            }
...
(function (u) {
    ...
    r = r.MD5 = v.extend({
        mP3x: function () {
            ...
            var a = this.co9f.words, c = q[n + 0], e = q[n + 1], j = q[n + 2], k = q[n + 3], z = q[n + 4], r = q[n + 5],
            ...
            var b = this.i7b, n = b.words, a = 8 * this.zz6t, c = 8 * b.sigBytes;
            n[c >>> 5] |= 128 << 24 - c % 32;
...
CryptoJS.lib.Cipher || function (u) {
    var p = CryptoJS, d = p.lib, l = d.Base, s = d.WordArray, t = d.BufferedBlockAlgorithm, r = p.enc.Base64,
        w = p.algo.EvpKDF, v = d.Cipher = t.extend({
            cfg: l.extend(), createEncryptor: function (e, a) {
                return this.create(this.KU9L, e, a)
            }, createDecryptor: function (e, a) {
                return this.create(this.buX0x, e, a)
            }, init: function (e, a, b) {
                ...
                e && this.Bl7e(e);
                return this.od3x()
            }, keySize: 4, ivSize: 4, KU9L: 1, buX0x: 2, np3x: function (e) {
                return {
    ...
    q.Encryptor = q.extend({
        processBlock: function (e, a) {
            var b = this.jo2x, c = b.blockSize;
            x.call(this, e, a, c);
            b.encryptBlock(e, a);
            this.Gz8r = e.slice(a, a + c)
        }
    });
    q.Decryptor = q.extend({
        processBlock: function (e, a) {
            var b = this.jo2x, c = b.blockSize, d = e.slice(a, a + c);
            b.decryptBlock(e, a);
            x.call(this, e, a, c);
            this.Gz8r = d
        }
    ...
    d.BlockCipher = v.extend({
        cfg: v.cfg.extend({mode: b, padding: q}), reset: function () {
            ...
            if (this.YV5a == this.KU9L) var c = a.createEncryptor; else c = a.createDecryptor, this.Yr4v = 1;
            this.eo0x = c.call(a, this, b && b.words)
        }, tC4G: function (a, b) {
            this.eo0x.processBlock(a, b)
        }, od3x: function () {
            var a = this.cfg.padding;
            if (this.YV5a == this.KU9L) {
                a.pad(this.i7b, this.blockSize);
                var b = this.hI1x(!0)
            } else b = this.hI1x(!0), a.unpad(b);
            return b
        }, blockSize: 4
    });
...
(function () {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], d = d.AES = p.extend({
        mP3x: function () {
            for (var a = this.K8C, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.KG9x = d + 6) + 1), e = this.OC1x = [], j = 0; j < a; j++) if (j < d) e[j] = c[j]; else {
                var k = e[j - 1];
            ...
            this.Gx8p(a, b, this.OC1x, t, r, w, v, l)
        }, decryptBlock: function (a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Gx8p(a, c, this.OG1x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        }, Gx8p: function (a, b, c, d, e, j, l, f) {
            for (var m = this.KG9x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++) var q = d[g >>> 24] ^ e[h >>> 16 & 255] ^ j[k >>> 8 & 255] ^ l[n & 255] ^ c[p++], s = d[h >>> 24] ^ e[k >>> 16 & 255] ^ j[n >>> 8 & 255] ^ l[g & 255] ^ c[p++], t = d[k >>> 24] ^ e[n >>> 16 & 255] ^ j[g >>> 8 & 255] ^ l[h & 255] ^ c[p++], n = d[n >>> 24] ^ e[g >>> 16 & 255] ^ j[h >>> 8 & 255] ^ l[k & 255] ^ c[p++], g = q, h = s, k = t;
